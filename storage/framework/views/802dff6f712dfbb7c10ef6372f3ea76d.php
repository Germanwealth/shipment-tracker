<?php $__env->startSection('title', 'Track Your Shipment'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <form action="<?php echo e(route('tracking.search', '')); ?>" method="GET" onsubmit="handleSearch(event)" class="space-y-4">
                <div>
        ...
        <div class="text-center mt-8">
            ...
            <p class="text-gray-500 text-xs mt-4"><a href="<?php echo e(route('admin.login')); ?>" class="hover:text-blue-600">Admin Login</a></p>
        </div>
    </div>
</div>
...
function handleSearch(e) {
    ...
    if (code) {
        window.location.href = `<?php echo e(route('tracking.search', '')); ?>/${code}`;
    }
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/codecps/Desktop/tracker/resources/views/tracking/index.blade.php ENDPATH**/ ?>