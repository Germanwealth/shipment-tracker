<?php $__env->startSection('title', 'Track Your Shipment - Nuelcargo'); ?>
            ...
            <div class="bg-white rounded-lg shadow-2xl p-10">
                ...
                <div class="mt-10 p-6 bg-blue-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $examples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white p-3 rounded border border-blue-200 cursor-pointer hover:border-blue-400 transition" onclick="document.querySelector('input[name=code]').value='<?php echo e($code); ?>'; document.querySelector('form').submit();">
                            <code class="font-mono text-blue-600"><?php echo e($code); ?></code>
                        </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/codecps/Desktop/tracker/resources/views/tracking/index.blade.php ENDPATH**/ ?>